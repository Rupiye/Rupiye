// Copyright (c) 2017-2020 The RUPIYE Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RUPIYE_CRYPTO_MUHASH_H
#define RUPIYE_CRYPTO_MUHASH_H

#if defined(HAVE_CONFIG_H)
#include <config/rupiye-config.h>
#endif
 ...
 * https://lists.linuxfoundation.org/pipermail/rupiye-dev/2017-May/014337.html.
 */
class MuHash3072
{
private:
