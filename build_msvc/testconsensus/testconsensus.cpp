// Copyright (c) 2020-2021 The Rupiye Core developers
...
// rupiye includes.
#include <..\src\script\rupiyeconsensus.h>
...
int main()
{
    std::cout << "rupiyeconsensus version: " << rupiyeconsensus_version() << std::endl;
    ...
    ruypieconsensus_error err;
    auto op0Result =   ruypieconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, rupiyeconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
