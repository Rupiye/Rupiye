// Copyright (c) 2019 The RUPIYE Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef RUPIYE_CRYPTO_CHACHA_POLY_AEAD_H
#define RUPIYE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@rupiye.
 *
 ...
 *
 * The chacha20-poly1305@rupiye combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@rupiye cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@rupiye are relatively fast in
...
#endif // RUPIYE_CRYPTO_CHACHA_POLY_AEAD_H
