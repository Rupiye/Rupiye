...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Rupiye
else
  DOCKER_EXEC echo \> \$HOME/.rupiye
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/rupiye/rupiye/pull/18288#discussion_r433189350 for
  # details.
