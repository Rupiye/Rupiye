...
const std::string EXAMPLE_ADDRESS[2] = {"in1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "in1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
{
    return "> rupiye-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> rupiye-cli -named " + methodname;
