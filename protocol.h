...
#ifndef RUPIYE_RPC_PROTOCOL_H
#define RUPIYE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in rupiyed
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Rupiye is not connected
